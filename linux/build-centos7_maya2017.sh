...
if [ -f ../apps/maya2017/Autodesk_Maya_2017_Update1_P01.tgz -a -f ../apps/maya2017/Maya2017_DEVKIT_Linux.tgz ]; then
  ...
  docker build -t "usd-docker/maya2017:centos7-usd-0.7" -f centos7/dcc/Dockerfile_maya2017 .
  rm -Rf apps
else
...
echo "Build USD"
docker build -t "usd-docker/usd:centos7-usd-0.7.5" -f centos7/usd/Dockerfile_maya2017 .
