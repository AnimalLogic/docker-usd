...
if [ ! -f "$DOWNLOADS_DIR/Autodesk_Maya_2018_EN_Linux_64bit.tgz" ]; then
  echo "Couldn't find file $DOWNLOADS_DIR/Autodesk_Maya_2018_EN_Linux_64bit.tgz"
  exit 1
fi

if [ ! -f "$DOWNLOADS_DIR/Maya2018_DEVKIT_Linux.tgz" ]; then
  echo "Couldn't find file $DOWNLOADS_DIR/Maya2018_DEVKIT_Linux.tgz"
  exit 1
fi
...
echo "Build USD"
docker build -t "usd-docker/usd:0.8.1-centos7-maya2018" -f centos7/usd/Dockerfile_maya2018 .
docker tag "usd-docker/usd:0.8.1-centos7-maya2018" "usd-docker/usd:0.8.1-centos7-maya2018"
docker tag "usd-docker/usd:0.8.1-centos7-maya2018" "usd-docker/usd:latest-centos7-maya2018"
docker tag "usd-docker/usd:0.8.1-centos7-maya2018" "usd-docker/usd:latest-centos7-mayalatest"
